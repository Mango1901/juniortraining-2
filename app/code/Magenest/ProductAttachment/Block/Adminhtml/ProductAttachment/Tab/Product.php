...
namespace Magenest\ProductAttachment\Block\Adminhtml\ProductAttachment\Tab;
...
class Product extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        parent::_construct();
        $this->setId('sparsh_product_attachment');
    ...
    {
        return $this->getUrl('productattachment/*/grid', ['_current' => true]);
    }

...
class NewAction extends \Magenest\ProductAttachment\Controller\Adminhtml\ProductAttachment
{
    /**
     * ResultPageFactory
     *
     ...
     * @param \Magenest\ProductAttachment\Model\ProductAttachment $attachmentLoader

 ...
 */
namespace Sparsh\ProductAttachment\Ui\Component\Listing\Column;
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item['icon'])) {
                    ...
                    if ($item[$this->getData('name')] === 'pdf') {
                        $item[$this->getData('name') . '_src'] = $mediaUrl . "/sparsh/product_attachment/tmp/pdf_image.png";
                    } elseif ($item[$this->getData('name')] === 'doc' | $item[$this->getData('name')] === 'docx') {
                        $item[$this->getData('name') . '_src'] = $mediaUrl . "/sparsh/product_attachment/tmp/doc_image.png";
                    } elseif ($item[$this->getData('name')] === 'xls' | $item[$this->getData('name')] === 'xlsx') {
                        $item[$this->getData('name') . '_src'] = $mediaUrl . "/sparsh/product_attachment/tmp/excel.png";
                    }
                }
            }
        }
